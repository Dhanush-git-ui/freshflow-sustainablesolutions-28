      ...
      <section className="pt-20 pb-32 bg-black/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { image: "/lovable-uploads/3071e718-34c5-4dcb-ba6d-cf335414e921.png", size: "1L" },
              { image: "/lovable-uploads/ed8641de-c186-4083-9006-46534e29e81b.png", size: "500ml" },
              { image: "/lovable-uploads/c81c96e5-c6ab-47ae-96c4-87066204c1a5.png", size: "200ml" },
            ].map((product) => (
